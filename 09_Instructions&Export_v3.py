...
----- V3:
Added cheapest, most expensive and average unit prices to exported data.
Also added a recommended variable to component 8 for this component to be added
to the exported information
"""
...
g_or_l = "g"
cheapest_brand = "Fanta"
cheapest_brand = [cheapest_brand]  # converting into a list
expensive_brand = "L&P"
expensive_brand = [expensive_brand]
average_unit_price = 2.52
average_unit_price = [average_unit_price]
recommended = "Fanta"  # Set by component 9
recommended = [recommended]

# makes data frame to export
export_frame = pandas.DataFrame([price_list, amount_list, unit_value_list,
                                 cheapest_brand, expensive_brand,
                                 average_unit_price, recommended],
